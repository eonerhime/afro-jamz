            ...
            <div className="flex gap-6 items-center">
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link
                    to="/register"
                    className="bg-linear-to-r from-primary-600 to-secondary-600 text-white px-6 py-2 rounded-lg hover:from-primary-700 hover:to-secondary-700 font-medium shadow-md hover:shadow-lg transition-all"
                  >
                    Sign Up
                  </Link>
                </>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <div className="flex gap-6 justify-center flex-wrap">
            <Link
              to="/beats"
              className="bg-linear-to-r from-primary-600 to-secondary-600 text-white px-10 py-4 rounded-xl text-lg font-semibold hover:from-primary-700 hover:to-secondary-700 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all"
            >
              🎵 Explore Beats
            </Link>
            {!isAuthenticated && (
        ...
        {/* Stats Section */}
        <div className="mt-24 bg-linear-to-r from-primary-600 via-secondary-600 to-accent-600 rounded-3xl p-12 text-white shadow-2xl">
        ...
        <div className="mt-24 text-center">
          ...
          <Link
            to="/beats"
            className="inline-block bg-linear-to-r from-primary-600 to-secondary-600 text-white px-12 py-4 rounded-xl text-xl font-semibold hover:from-primary-700 hover:to-secondary-700 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all"
          >
            Start Browsing Now →
          </Link>
        </div>
